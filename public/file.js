...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'file.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'file.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'file.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "file.html.mem" : null;
